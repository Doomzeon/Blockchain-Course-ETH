...
def get_contract(contract_name: str, ):
    ...
    overwhise it will deploy a mock version of that contract and return that mopck contract
    ...
    if network.show_active() in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
        ...
        contract_adress = config["networks"][network.show_active(
        )][contract_name]
        contract = Contract.from_abi(
            contract_type._name, contract_adress, contract_type.abi)
    return contract
